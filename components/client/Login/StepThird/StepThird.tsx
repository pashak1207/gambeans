...
export default function StepThird({state, setState, dictionary}:{state:ILoginRegistrationState, setState : React.Dispatch<SetStateAction<ILoginRegistrationState>>, dictionary:Third}) {
    ...
    const  nextBtnHandler = async () => {
        ...
        if(UserUtils.validateDate(day, month, year) && UserUtils.validateName(name)){
            ...
            const { isAdmin } = await AuthClientService.registration(state.phone!, name, inputDate)
